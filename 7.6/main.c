...
void main(void)
{
    ...
    strcpy(cad1, cad0);
    /* La función strcpy permite copiar una cadena de caracteres completa. En este caso se copia la cadena cad0 a cad1.
    Si el espacio reservado para cad1 es menor que el de cad0, se genera un error en la ejecución del programa. */
    ...
    Siempre se debe incorporar al final de la cadena el caracter de terminación. Si el espacio reservado para cad2 es menor que lo que se pretende copiar, se genera un error en la ejecución del programa. */
    ...
    strcat(cad0, cad3);
    /* La función strcat permite incorporar una cadena de caracteres a otra cadena dada. En este caso se agrega la cadena cad3 a cad0.
