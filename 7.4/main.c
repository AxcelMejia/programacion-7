...
void main(void)
{
    ...
    Para que un apuntador de tipo cadena de caracteres se pueda utilizar con la función de lectura gets, es necesario inicializarlo como se hace en la siguiente instrucción. */
