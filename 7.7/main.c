...
void main (void)
{
    ...
    i = strcmp(cad0, cad3);
    printf("\nResultado de la comparacion-cad0 y cad3-: %d", 1);
    ...
    /* La función strchr busca la posición en la que se encuentra un determinado caracter en la cadena de caracteres.
